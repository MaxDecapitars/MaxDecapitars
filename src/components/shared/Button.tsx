...
const Button = ({ children, onClick, type = 'button', title }: Props) => {
  const clipPath =
    '[clip-path:_polygon(80%_0,_100%_30%,_100%_100%,_0_100%,_0_0)]';
  const gradient =
  ...
  return (
    ...
    >
      <span
        className={`flex h-full items-center justify-center rounded-md bg-white bg-opacity-80 p-1 uppercase ${clipPath} leading-none dark:bg-black dark:bg-opacity-70`}
      >
        {children}
      </span>
    </motion.button>
